...
const WEAPON_KEYWORD_OVERRIDES: Record<string, string[]> = {
  ...
  'eq_gasgrenades'             : ['gl_injurydice-1', 'gl_ignoremodifiercover', 'gl_ignoremodifierlong_range', 'gl_assault', 'gl_blast3', 'gl_ignorearmour', 'gl_gas', 'gl_grenade'],
  ...
  'eq_infernalbomb'            : ['gl_ignoremodifiercover', 'gl_ignoremodifierlong_range', 'gl_ignoremodifierelevated_position', 'gl_blast3', 'gl_scatter', 'gl_shrapnel', 'gl_reload'],
