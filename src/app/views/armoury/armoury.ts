...
export class ArmouryView {
  ...
  readonly currentEntries = computed<AnyDataEntry[]>(() => {
    switch (this.category()) {
      case 'equipment':     return this.gameData.equipmentList();
      case 'abilities':     return this.gameData.skillList();
      case 'glossary':      return this.gameData.glossaryList();
      case 'models':        return this.gameData.modelList();
      case 'variant-rules': return this.gameData.variantRuleList();
      case 'addons':        return this.gameData.addonList();
    }
  });
  ...
  asEquipment(e: AnyDataEntry): Equipment | null     { return e.type === 'Equipment'    ? e as Equipment    : null; }
  asModel(e: AnyDataEntry): Model | null             { return e.type === 'Model'        ? e as Model        : null; }
  asAddon(e: AnyDataEntry): Addon | null             { return e.type === 'Addon'        ? e as Addon        : null; }
  asVariantRule(e: AnyDataEntry): VariantRule | null { return e.type === 'VariantRule'  ? e as VariantRule  : null; }
}
